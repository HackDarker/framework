...
exports.isPingHu = function(seatData,checkJings,chupai){
	numOfJings = 0;
...
exports.isJingDiao = function(jm,seatData,kehu7dui){
	jingMap = jm;
	var jing = null;
	numOfJings = 0;
	for(var k in seatData.countMap){
...
exports.checkCanHu = function (jm,seatData,pai,kehu7dui){
	jingMap = jm;
	//判断是不是7对
	if(kehu7dui){
		var ret = exports.is7Pairs(seatData,true,pai);
		if(ret){
			//7对
			return "7pairs";
		}
	...
	//判断是不是碰碰胡
	var ret = exports.is4Melds(seatData,true,pai);
	if(ret){
		//碰碰胡
		return "4melds";
	}
	...
	//判断是不是平胡
	var ret = exports.isPingHu(seatData,true,pai);
	if(ret){
		//平胡
		return "normal";
	}
